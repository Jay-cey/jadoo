    ...
    <main className="flex min-h-screen flex-col items-center justify-between w-full mx-auto overflow-hidden">
      <section className="grid grid-cols-2 w-5/6">
        <div className="grid content-center gap-6">
          <p className="text-[#DF6951] uppercase font-bold text-xl">
            Best Destinations around the world
          </p>
          <h2 className="text-7xl font-bold text-[#181E4B]">
            Travel, enjoy <br /> and live a new <br /> and full life
          </h2>
          <p className="font-medium text-[#5E6282] leading-7">
        ...
        <div className="">
          ...
          <Image
            ...
            width={1000}
            height={500}
            className="absolute -z-50 lg:-top-20 -right-20 w-6/12"
          />
        </div>
      </section>
      ...
      <section className="grid grid-cols-2 w-5/6 mx-auto my-24">
        <div className="space-y-5">
          <div className="space-y-2">
      ...
      <section className="my-24 bg-[#DFD7F9] rounded-tl-[6rem] rounded-3xl h-96 w-5/6 text-center px-8 py-14 flex flex-col justify-around relative">
        <p className="font-semibold text-4xl text-[#5E6282] w-4/5 mx-auto leading-[3rem]">
        ...
        <form action="#" method="post" className="space-x-3">
          <input
            ...
            className="placeholder:text-sm placeholder:text[#39425D] w-2/5 px-3 py-3 rounded-lg focus:outline-[#DFD7F9]"
          />

          <button
            type="submit"
            className="h-full px-7 py-3 text-white rounded-lg bg-gradient-to-b from-[#FF946D] to-[#FF7D68]"
          >
            Subscribe
          </button>
        </form>
        ...
        <Image
          ...
          width={100}
          height={100}
          className="w-16 h-auto absolute -top-6 -right-5"
        />
        <Image
          src="/mask.svg"
          alt="subscribe"
          width={100}
          height={100}
          className="w-48 h-auto absolute right-0 top-0"
        />
        <Image
          src="/mask1.svg"
          alt="subscribe"
          width={500}
          height={500}
          className="w-96 max-w-80 h-auto absolute bottom-0 -left-16"
        />
      </section>
    </main>
  );
